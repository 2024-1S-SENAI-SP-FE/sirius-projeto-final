const EarthOverview = (event) => {
    ...
    document.getElementById("source-planetas").setAttribute("href", "https://en.wikipedia.org/wiki/Earth#Internal_structure")
...
const EarthSurfaceGeology = (event) => {
    ...
    document.getElementById("source-planetas").setAttribute("href", "https://en.wikipedia.org/wiki/Earth#Surface_geology")
