...
const VenusInternalStructure = (event) =>{
    ...
    const textPlanets = document.getElementById("texto-planetas")
    textPlanets.innerText = `The similarity in size and density between Venus and Earth suggests they share a similar internal structure: a core, mantle, and crust. Like that of Earth, Venusian core is most likely at least partially liquid because the two planets have been cooling at about the same rate.
  `
...
const VenusSurfaceGeology = (event) => {
    ...
    const textPlanets = document.getElementById("texto-planetas")
    textPlanets.innerText = `Much of the Venusian surface appears to have been shaped by volcanic activity. Venus has several times as many volcanoes as Earth, and it has 167 large volcanoes that are over 100 km (60 mi)across. The only volcanic complex of this size on Earth is the Big Island of Hawaii.`
...
const ButtonStyle = () => {
    ...
    Buttons.forEach(button => {
        ...
        button.addEventListener('focus', () => {
            button.style.background = '#EDA249';
        });
