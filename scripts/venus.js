...
const INTERNAL_STRUCTURE = (event) =>{
    event.preventDefault()
...
const SURFACE_GEOLOGY = (event) => {
    ...
    document.getElementById("source-planets").setAttribute("href", "https://en.wikipedia.org/wiki/Venus#Surface_geology")
